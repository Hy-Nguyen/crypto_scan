...
export default async function getCitrus(
  ...
  // repeated, can be replaced with return citrusData below
  return {
  ...
  // Convert loan summary to JSON string
  const citrusSummJSON = JSON.stringify(citrusResponseJson["loanSummary"])


  // Convert values into JSON 
  const citrusJSON = JSON.stringy(citrusData);


  // Test JSON returns
  console.log(citrusJSON);
  console.log(citrusSummJSON)


} // end of getCitrus function
